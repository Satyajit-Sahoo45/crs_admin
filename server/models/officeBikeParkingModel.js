...
const officeBikeParkingModel = mongoose.Schema(
    {
...
const officeBikeParkModel = mongoose.model("officeBikeParkModel", officeBikeParkingModel);

module.exports = officeBikeParkModel;